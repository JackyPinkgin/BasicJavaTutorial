        ...
        while (true) {
            ...
            try {
                ...
                switch (message.getMsgType()) {
                    ...
                    case MessageType.MESSAGE_CLIENT_EXIT: //客户端退出的情况
                        ...
                        //退出while循环
                        break label;
                    case MessageType.MESSAGE_COMM_MES: //发送普通的一对一消息
...
//                        offlineMsg.add(message);
                        ...
                        break;
                    case MessageType.MESSAGE_TO_ALL_MES: //发送消息到全员
                        ...
                        break;
                    case MessageType.MESSAGE_FILE_MES: {//发送消息到全员
